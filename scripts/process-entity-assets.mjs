...
const sprites = [
  ...
  // animal multi-view
  ["animal-lion-side.png", "animal-lion-side.png"],
  ["animal-lion-back.png", "animal-lion-back.png"],
  ["animal-elephant-side.png", "animal-elephant-side.png"],
  ["animal-camel-side.png", "animal-camel-side.png"],
  ["animal-panda-side.png", "animal-panda-side.png"],
  ["animal-kangaroo-side.png", "animal-kangaroo-side.png"],
  ["animal-bear-side.png", "animal-bear-side.png"],
  ["animal-deer-side.png", "animal-deer-side.png"],
  // landmarks
  ...
  // landmark multi-view
  ["landmark-liberty-side.png", "landmark-liberty-side.png"],
  ["landmark-liberty-back.png", "landmark-liberty-back.png"],
  ["landmark-christ-redeemer-side.png", "landmark-christ-redeemer-side.png"],
  ["landmark-christ-redeemer-back.png", "landmark-christ-redeemer-back.png"],
  ["landmark-moai-side.png", "landmark-moai-side.png"],
  ["landmark-kotel-side.png", "landmark-kotel-side.png"],
  ["landmark-eiffel-side.png", "landmark-eiffel-side.png"],
  ["landmark-pyramid-side.png", "landmark-pyramid-side.png"],
